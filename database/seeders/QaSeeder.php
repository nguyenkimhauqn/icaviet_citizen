    ...
    public function run()
    {
        $data = [
            'Điều kiện thi quốc tịch' => [
                [
                    'question' => '1. Thi quốc tịch mà không biết tiếng Anh thì sao?',
                    'answer' => trim(<<<TEXT
Một trong các yêu cầu thi quốc tịch là bạn phải hiểu tiếng Anh cơ bản và có kiến thức về lịch sử, chính phủ Mỹ. Trong một số trường hợp, nếu đủ tuổi và thời gian cư trú theo <a target="_blank" href="https://www.uscis.gov/policy-manual/volume-12-part-e-chapter-2">quy định</a>, bạn có thể xin thi quốc tịch bằng tiếng Việt.
...
TEXT)
                ...
                [
                    'question' => '2. Thi bao nhiêu điểm mới đậu quốc tịch?',
                    'answer' => trim(<<<TEXT
...
TEXT)
                ...
                [
                    'question' => '3. Khi nào được thi quốc tịch Mỹ sau 3 năm?',
                    'answer' => trim(<<<TEXT
...
TEXT)
                ...
                [
                    'question' => '4. Khi nào được thi quốc tịch Mỹ sau 5 năm?',
                    'answer' => trim(<<<TEXT
...
TEXT)
            ...
            'Sau khi thi quốc tịch' => [
                ['question' => '5. Sau khi thi quốc tịch, bao lâu có kết quả?', 'answer' => "Kết quả của các phần thi quốc tịch sẽ được viên chức thông báo ngay sau buổi phỏng vấn."],
                ['question' => '6. Thi quốc tịch lần đầu không đậu, bao lâu có thể thi lại?', 'answer' => "Mỗi hồ sơ xin nhập tịch được phép thi tối đa 2 lần. Nếu trượt lần đầu, bạn sẽ được thi lại phần chưa đạt trong vòng 60 - 90 ngày kể từ ngày phỏng vấn đầu tiên."],
                ['question' => '7. Thi quốc tịch lần hai không đậu, có thể thi lại không?', 'answer' => "Không. Nếu bạn thi trượt lần thứ hai, hồ sơ nhập tịch của bạn sẽ bị từ chối. Khi muốn thi lại, bạn phải nộp Form N-400 và đóng mức phí mới."],
                [
                    'question' => '8. Sau khi trở thành công dân Mỹ thì cần làm gì tiếp theo?',
                    'answer' => trim(<<<TEXT
...
TEXT)
            ...
            'Kiến thức thi quốc tịch' => [
                [
                    'question' => '9. Cách tra cứu Thượng nghị sĩ (U.S. Senators), Dân biểu của Hạ viện (U.S. Representatives) và Thống đốc (Governors)?',
                    'answer' =>  trim(<<<TEXT
- Mỗi tiểu bang có 2 Thượng nghị sĩ (U.S. Senators), bạn có thể tra cứu tại:
<a target="_blank" href="https://www.senate.gov/senators/index.htm">https://www.senate.gov/senators/index.htm</a> 
...
<a target="_blank" href="https://www.house.gov/representatives">https://www.house.gov/representatives </a>

- Mỗi tiểu bang có 1 Thống đốc (Governor), bạn có thể tra cứu tại:
<a target="_blank" href="https://www.nga.org/governors/ ">https://www.nga.org/governors/ </a>
TEXT)
                ],
                [
                    'question' => '10. Nếu ở thủ đô Washington, D.C. thì có Thượng nghị sĩ (U.S. Senators), Dân biểu của Hạ viện (U.S. Representatives) và Thống đốc (Governors) không?',
                    'answer' => trim(<<<TEXT
- D.C. không có Thượng nghị sĩ (U.S. Senators). => Bạn có thể trả lời: “D.C. has no U.S. Senators.”

- D.C. có 1 đại diện duy nhất tại Hạ viện Hoa Kỳ, gọi là “Delegate” (nghị sĩ không có quyền biểu quyết). => Bạn có thể nhập ZIP Code và tra cứu tên của Delegate tại: <a target="_blank" href="https://www.house.gov/representatives">https://www.house.gov/representatives</a>
