...
@section('content')
    ...
    <main class="main-content">
        <div class="prepare-card">
            ...
            <p class="text-center text-muted mb-2 font-sm">Bạn đã hoàn thành các câu hỏi gắn sao trong chuyên mục này</p>
    ...
    <div class="test-footer">
        <div class="text-center mt-5">
            <a href="{{ route('n400.categories.starred') }}" class="btn btn-normal px-5 py-2">
